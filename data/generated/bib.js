const generatedBibEntries = {
    "hu_chatdb_2023": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, supported_operations:update, retrieval_data_type:text, retrieval_method:LLM-generated_SQL_query, updating_method:LLM-generated_SQL_query, LLMs, symbolic memory, SQL databases, multi-hop reasoning, memory framework",
        "langid": "english",
    ...
    "liu_think--memory_2023": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, supported_operations:update, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, long-term memory, iterative recalling, post-thinking, conversation stream",
        "langid": "english",
    ...
    "lu_memochat_2023": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, supported_operations:update, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, memos, long-range conversation, open-domain conversation, memorization-retrieval-response",
        "langid": "english",
    ...
    "modarressi_ret-llm_2023": {
        ...
        "keywords": "supported_operations:insert, retrieval_data_type:Triplet, retrieval_method:exact_match, retrieval_method:vector_similarity_search, updating_method:LLM-generated_Triplet_query, LLMs, memory unit, knowledge storage, retrieval, NLP, question-answering, temporal information",
        "langid": "english",
    ...
    "packer_memgpt_2024": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, supported_operations:update, retrieval_data_type:text, retrieval_method:vector_similarity_search, retrieval_method:KV_search, updating_method:LLM-generated_KV_pairs, updating_method:LLM-generated_sentences, LLMs, memory, context management, AI, document analysis, multi-session chat",
        "langid": "english",
    ...
    "park_generative_2023": {
        ...
        "isbn": "9798400701320",
        "keywords": "supported_operations:insert, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, interactive simulacra, human behavior, generative agents, user interface",
        "langid": "english",
    ...
    "schuurmans_memory_2023": {
        ...
        "keywords": "supported_operations:insert, supported_operations:update, retrieval_data_type:text, retrieval_method:KV_search, updating_method:LLM-generated_KV_pairs, LLMs, computationally universal, external memory, finite automaton, Turing machine",
        "langid": "english",
    ...
    "wang_enhancing_2024": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, supported_operations:update, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, self-controlled memory, dialogue memory, memory summarization",
        "langid": "english",
    ...
    "zheng_memoryrepository_2024": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, AI NPC, long-term memory, human-like memory, conversation records, human-like interaction",
        "langid": "english",
        "pages": "62581--62596",
    ...
    "zhong_memorybank_2024": {
        ...
        "keywords": "supported_operations:insert, supported_operations:delete, retrieval_data_type:text, retrieval_method:vector_similarity_search, updating_method:LLM-generated_sentences, LLMs, long-term memory, AI Companion, memory updating, Ebbinghaus Forgetting Curve",
        "langid": "english",
        "number": "17",
        "pages": "19724--19731",
        "shortjournal": "AAAI",
